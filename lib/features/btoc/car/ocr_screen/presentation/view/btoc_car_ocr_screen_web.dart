...
class BtocCarOcrScreenWeb extends ConsumerWidget {
  const BtocCarOcrScreenWeb({super.key});
                              ...
                              MouseRegion(
                                ...
                                child: Column(
                                  children: [
                                    GestureDetector(
                                      onTap: (){
                                        appiNavigate(context: context, path:
                                        '/btoc_car_more_details');
                                      },
                                      child: TextAppi(
